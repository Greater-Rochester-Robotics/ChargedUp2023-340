...
import frc.robot.commands.claw.ClawCloseLight;
import frc.robot.commands.claw.ClawIntake;

// NOTE:  Consider using this command inline, rather than writing a subclass.  For more
// information, see:
// https://docs.wpilib.org/en/stable/docs/software/commandbased/convenience-features.html
public class ArmWristExtendAndCloseLight extends SequentialCommandGroup {
  /** Creates a new ArmWristExtendAndCloseHard. */
  public ArmWristExtendAndCloseLight() {

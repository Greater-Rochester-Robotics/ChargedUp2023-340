 ...
 */
public class AutoDriveFollowTrajectory extends CommandBase {
    /**
     ...
     */
    public AutoDriveFollowTrajectory (String pathFileName) {
     ...
     */
    public AutoDriveFollowTrajectory (String pathFileName, double maxVel, double maxAccel) {
     ...
     */
    public AutoDriveFollowTrajectory (String pathFileName, double maxVel, double maxAccel, boolean resetOdometry) {
     ...
     */
    public AutoDriveFollowTrajectory (PathPlannerTrajectory trajectory) {
     ...
     * @param resetOdometry If odometry should be reset to the starting point.
     */
    public AutoDriveFollowTrajectory (PathPlannerTrajectory trajectory, boolean resetOdometry) {

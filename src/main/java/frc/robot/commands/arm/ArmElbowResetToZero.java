...
public class ArmElbowResetToZero extends CommandBase {
  ...
  public void end(boolean interrupted) {
    ...
    if(!interrupted && DriverStation.isDisabled()){
      RobotContainer.arm.zeroElbow();
    }else if(interrupted){
      System.out.println("WARNING: RESET OF ELBOW COMMAND INTERRUPTED - RESET FAILED");
      DriverStation.reportWarning("WARNING: RESET OF ELBOW COMMAND INTERRUPTED - RESET FAILED",false);
